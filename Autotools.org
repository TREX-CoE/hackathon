...
--------------------------------
  ...
  If you want to go deeper into Autotools, we recommend the book
  [[https://nostarch.com/autotools.htm][A Practitioner's Guide to GNU Autoconf, Automake, and Libtool]] by John Calcote.
