...
This page contains the [[https://www.gnu.org/software/autoconf/][GNU Autoconf]] tutorial, which is the first part of the [[./Autotools.html][Autotools tutorial]].
...
* TODO Improvements
  ...
  - Add the link to the repository where to get the Sherman-Morrison code
  - Picture in section 3
