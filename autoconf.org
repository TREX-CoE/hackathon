...
The project can be downloaded using the following link: https://github.com/q-posev/Sherman-Morrison/archive/refs/tags/v0.1-demo.tar.gz. 
...
This means that if the current environment (e.g. ~trex-hackathon~ created with ~conda~) did some smart job 
and pre-set some compiler options, this information is lost.

Now, let's append to the existing flags using ~+=~ syntax of of Makefile.
...
LDFLAGS  += -L/home/evgeny/.conda/envs/autotools/lib
#+end_src
...
g++ -fPIC -isystem /home/evgeny/.conda/envs/autotools/include -std=c++11   -I./include/  -c -o src/SM_Maponi.o src/SM_Maponi.cpp
g++ -fPIC -isystem /home/evgeny/.conda/envs/autotools/include -std=c++11   -I./include/  -c -o src/SM_Standard.o src/SM_Standard.cpp
g++ -fPIC -isystem /home/evgeny/.conda/envs/autotools/include -std=c++11   -I./include/  -c -o src/Woodbury.o src/Woodbury.cpp
g++ -fPIC -isystem /home/evgeny/.conda/envs/autotools/include -std=c++11   -I./include/  -c -o src/SMWB.o src/SMWB.cpp
g++ -fPIC -isystem /home/evgeny/.conda/envs/autotools/include -std=c++11   -I./include/  -c -o src/Helpers.o src/Helpers.cpp
g++ -fPIC -isystem /home/evgeny/.conda/envs/autotools/include -std=c++11   -I./include/  -c -o tests/test_h5.o tests/test_h5.cpp
g++  -I./include/ -fPIC -isystem /home/evgeny/.conda/envs/autotools/include -std=c++11 tests/test_h5.o src/SM_Maponi.o src/SM_Standard.o src/Woodbury.o src/SMWB.o src/Helpers.o -o bin/test_h5  -L/home/evgeny/.conda/envs/autotools/lib -lhdf5 -lhdf5_cpp -lz
#+end_src

So it works now.

#+begin_question
What is going to happen when you give the updated =Makefile= back to your colleague?
#+end_question
...
CXX ...........:  /home/evgeny/.conda/envs/autotools/bin/x86_64-conda-linux-gnu-c++
...
#+begin_question
In the example above, we forgot to add one ~C++~ compiler flag. Which one?
#+end_question

Good, but we still have the hard-coded path to ~lib~ directory in ~LDFLAGS~.
Among other things, this directory contain the HDF5 library.
...
CPPFLAGS ......:  -I/home/evgeny/.conda/envs/autotools/include   -I./include/
LDFLAGS .......:   -L/home/evgeny/.conda/envs/autotools/lib  
...
#+begin_question
Try to reconfigure using ~./configure --without-hdf5~ or ~./configure --with-hdf5~. 
...
Many *Autoconf* macros (including ~PKG_CHECK_MODULES~) allows to specify
