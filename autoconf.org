...
- by downloading the project from the *Assets* section (either ~.zip~ or ~.tar.gz~) on the following webpage: https://github.com/q-posev/Sherman-Morrison/releases/tag/v0.1-demo. Make sure to extract the files from the archive before starting the tutorial.
