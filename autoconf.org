...
This page contains the [[https://www.gnu.org/software/autoconf/][GNU Autoconf]] tutorial, which is the first part of the [[./index.html][Autotools tutorial]].
  ...
  #+begin_tip
Before you proceed to the tutorial, download the example project called *Sherman-Morrison*. This can be done in 2 ways:

- using *Git* if you are familiar with it: ~git clone https://github.com/q-posev/Sherman-Morrison.git~
- by downloading the project from the *Assets* section (either ~.zip~ or ~.tar.gz~) on the following webpage: https://github.com/q-posev/Sherman-Morrison/archive/refs/tags/v0.1-demo.tar.gz . Make sure to extract the files from the archive before starting the tutorial.
...
We will learn how to automatically locate the HDF5 library using macros.
  ...
  #+begin_tip
In the examples demonstated in this tutorial,
the OS is Ubuntu with the default GNU compilers ~gcc/g++ 9.3.0~
and with the HDF5 library installed via ~sudo apt-get install libhdf5-dev~ command.
  #+end_tip
...
#+begin_src
$ make
g++ -g -O2 -std=c++11 -I/usr/include -I/usr/include/hdf5/serial  -I./include/  -c -o src/SM_Maponi.o src/SM_Maponi.cpp
In file included from /home/test/.conda/envs/trex-hackathon/x86_64-conda-linux-gnu/sysroot/usr/include/sys/types.h:136,
                 from /home/test/.conda/envs/trex-hackathon/x86_64-conda-linux-gnu/sysroot/usr/include/stdlib.h:320,
                 from /home/test/.conda/envs/trex-hackathon/x86_64-conda-linux-gnu/include/c++/9.4.0/bits/std_abs.h:38,
                 from /home/test/.conda/envs/trex-hackathon/x86_64-conda-linux-gnu/include/c++/9.4.0/cmath:47,
                 from ./include/Helpers.hpp:3,
                 from src/SM_Maponi.cpp:5:
/usr/include/time.h:37:10: fatal error: bits/types/clock_t.h: No such file or directory
   37 | #include <bits/types/clock_t.h>
      |          ^~~~~~~~~~~~~~~~~~~~~~
compilation terminated.
make: *** [<builtin>: src/SM_Maponi.o] Error 1
#+end_src

- Remove paths related to =/usr/local/=
- Remove `-lsz`, specific to HDF5 installation on the developer's platform
- Insert ~CPPFLAGS~ coming from the environment
...
#+begin_src
$ make
g++ -g -O2 -std=c++11 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/test/.conda/envs/trex-hackathon/include -I./include/  -c -o src/SM_Maponi.o src/SM_Maponi.cpp
g++ -g -O2 -std=c++11 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/test/.conda/envs/trex-hackathon/include -I./include/  -c -o src/SM_Standard.o src/SM_Standard.cpp
g++ -g -O2 -std=c++11 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/test/.conda/envs/trex-hackathon/include -I./include/  -c -o src/Woodbury.o src/Woodbury.cpp
g++ -g -O2 -std=c++11 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/test/.conda/envs/trex-hackathon/include -I./include/  -c -o src/SMWB.o src/SMWB.cpp
g++ -g -O2 -std=c++11 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/test/.conda/envs/trex-hackathon/include -I./include/  -c -o src/Helpers.o src/Helpers.cpp
g++ -g -O2 -std=c++11 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/test/.conda/envs/trex-hackathon/include -I./include/  -c -o tests/test_h5.o tests/test_h5.cpp
g++ -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/test/.conda/envs/trex-hackathon/include -I./include/ -g -O2 -std=c++11 tests/test_h5.o src/SM_Maponi.o src/SM_Standard.o src/Woodbury.o src/SMWB.o src/Helpers.o -o bin/test_h5  -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/test/.conda/envs/trex-hackathon/lib -Wl,-rpath-link,/home/test/.conda/envs/trex-hackathon/lib -L/home/test/.conda/envs/trex-hackathon/lib -lhdf5_cpp -lhdf5
#+end_src
...
CXX ...........:  /home/test/.conda/envs/trex-hackathon/bin/x86_64-conda-linux-gnu-c++
CXXFLAGS ......:  -fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/test/.conda/envs/trex-hackathon/include
...
---
> CXX      = /home/test/.conda/envs/trex-hackathon/bin/x86_64-conda-linux-gnu-c++
> CXXFLAGS = -fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/test/.conda/envs/trex-hackathon/include -std=c++11
#+end_src
...
#+begin_tip
To re-create quickly the Makefiles without re-running ~./configure~,
...
CXX ...........:  /home/test/.conda/envs/trex-hackathon/bin/x86_64-conda-linux-gnu-c++
CXXFLAGS ......:   -fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/test/.conda/envs/trex-hackathon/include -std=c++11
CPPFLAGS ......:  -I/home/test/.conda/envs/trex-hackathon/include -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/test/.conda/envs/trex-hackathon/include -I./include/
LDFLAGS .......:   -L/home/test/.conda/envs/trex-hackathon/lib -Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/test/.conda/envs/trex-hackathon/lib -Wl,-rpath-link,/home/test/.conda/envs/trex-hackathon/lib -L/home/test/.conda/envs/trex-hackathon/lib
...
#+begin_tip
The minimal setup of ~pkg-config~ consists of calls to the
initialization macro ~PKG_PROG_PKG_CONFIG~ and the search macro ~PKG_CHECK_MODULES~.
#+end_tip

The ~PKG_CHECK_MODULES~ can be configured to check the required version of the HDF5 library (see [[https://autotools.io/pkgconfig/pkg_check_modules.html][the Autotools Mythbuster website]] for more details).
