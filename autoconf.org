...
Luckily for us, the GNU website has an [[https://www.gnu.org/software/autoconf-archive/The-Macros.html][archive of Autoconf macros]] for commonly used programs, including HDF5.
The ~ax_lib_hdf5.m4~ file can be downloaded from the aforementioned page. 
Autoconf can locate external macros in the root directory of the project or in the ~m4~ directory.
...
~apt-get install libhdf5-dev~ command.
