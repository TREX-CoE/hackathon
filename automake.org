...
You have seen in the *Autoconf* tutorial how to write =configure.ac= and =Makefile.in=.
Here, we introduce *Automake* which will produce the =Makefile.in= from a simplified file =Makefile.am=.
The produced file 
